...
def main(region, model, scenario):
    ...
    for n in range(0, tc_tracks.size, k):
        ...
        haz_str = f"TC_{region}_0{res}as_MIT_{model}_{scenario}_H08_{n}.hdf5"
